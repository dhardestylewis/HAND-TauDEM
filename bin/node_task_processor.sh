...
## Usage:
##  sbatch node_task_processor.sh --job 1 --path_log hand_taudem.log --path_cmds bin/workflow_commands-hand_taudem.sh --path_cmd_outputs bin/workflow_outputs-hand_taudem.txt --path_rc bin/workflow_configuration-hand_taudem.sh --queue development --start_time $(date -u +%s) HUC1 HUC2 HUC3
